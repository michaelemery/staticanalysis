...
description | false negative /<br> score | false positive found | result /<br> total score | 
| --- | :---: | :---: | :---: |
| Found the error and nothing else.| no<br> *score = +2* | no<br> *score = +1* |accurate <br> *score = +3* | 
| Found the error but wrongly flagged safe code. | no false neg <br> *+2* | false pos found <br> *-1* | imprecise <br> *+1* |
