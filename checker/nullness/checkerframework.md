...
Results can be replicated on [Docker](https://docs.docker.com/docker-hub/) repository `michaelemery/staticanalysis`. Copy/paste the commands provided. Some outputs have been reformatted for readability.
